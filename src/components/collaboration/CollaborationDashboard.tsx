...
const _getActivityLevel = (session: CollaborationSession) => { const _totalActivity = session.comments + session.changes, if (totalActivity > 30) {r}eturn { level: 'High', color: 'bg-green-500'  };
