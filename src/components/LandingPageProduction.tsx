...
export default function LandingPageProduction(): void {;
          ...
          <div className="flex justify-center mb-12"></div>
            <div className="bg-white dark:bg-gray-800 rounded-full p-1 shadow-lg"></div>
              <button
                ...
                className={`cn(`
                  "px-6 py-3 rounded-full transition-all" selectedTier === 'no-code'
              ...
              <button
                ...
                className={`cn(`
                  "px-6 py-3 rounded-full transition-all" selectedTier === 'pro-code'
                    ? "bg-orange-500 text-white"
                    : "text-gray-600 dark:text-gray-400"
                )`}`
              ></button>
