...
export default function LandingPageProduction() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
          <header className={cn("fixed top-0 w-full z-50 transition-all", scrolled && "bg-white/80 backdrop-blur-md shadow-sm")}></header>
      ...
      <section className="pt-32 pb-20 px-4">
          ...
          <div className="relative">
              <Input
                type="text";
                value={appIdea}
                onChange={(e) => setAppIdea(e.target.value)}</Input>
              ...
              ></Button>
                {isLoading ? 'Building...' : <any>Build Now <ArrowRight className="w-4 h-4 ml-2"   />}
              </Button>
            </div>
