...
export default function TemplateMarketplace({
  ...
  return (<div className="space-y-6">;
      ...
      <div className="flex flex-col sm:flex-row gap-4 flex-1 relative"></div>
...
Badge className="ml-2 bg-yellow-100 text-yellow-800">Featured</Badge>
            ...
            <CardContent>
              ...
              <div className="flex items-center justify-between flex items-center space-x-4 text-sm text-gray-500"></div>
