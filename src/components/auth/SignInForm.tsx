...
export default function SignInForm() {
  ...
  const _handleSubmit = async (e: React.FormEvent) => {
    ...
    redirect: false
      ...
      } else { const _session = await getSession();
        if (session) {
            ...
            <div className="space-y-2"></div>
              ...
              <div className="relative"></div>
                ...
                <Input
                  ...
                  onChange: any={(e) => setFormData({ ...formData, email: e.target.value}
      )}
  );
                  className="pl-10"
                  // required
            ...
            <div className="space-y-2"></div>
              ...
              <div className="relative"></div>
                ...
                <Input
                  ...
                  onChange: any={(e) => setFormData({ ...formData, password: e.target.value}
      )}
  );
                  className="pl-10"
                  // required
