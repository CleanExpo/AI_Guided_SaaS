...
export default function EnterpriseDashboard({
  ...
  return (
    <div className="space-y-6">
      {/* Header */}</div>
      <div className="flex flex-col space-y-4 flex items-center justify-between"></div>
          <div>
...
Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1, md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="space-y-2 flex items-center justify-between"></div>
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4 flex items-center space-x-2"></div>
            ...
            <CardContent>
              <div className="space-y-4">
                {revenueMetrics.subscriptionBreakdown.map((tier) => (\n    </div>
                  <div key={tier.tier} className="space-y-2 flex justify-between items-center"></div>
                      <span className="text-sm font-medium capitalize">
                        {tier.tier}</span>
                      <div className="text-right text-sm font-bold"></div>
            ...
            <CardContent>
              <div className="space-y-3">
                {userMetrics.topCountries.slice(0, 5).map((country) => (\n    </div>
                  <div
                    key={country.country}
                    className="flex items-center justify-between flex items-center space-x-2"></div>
            ...
            <CardContent>
              <div className="space-y-3">
                {contentMetrics.topFrameworks.slice(0, 5).map((framework) => (\n    </div>
                  <div key={framework.framework} className="space-y-1 flex justify-between items-center"></div>
                      <span className="text-sm font-medium capitalize">
