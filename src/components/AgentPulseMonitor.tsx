        ...
        <CardContent className="space-y-4">
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-sm font-medium">
                {pulse.resources.cpuUsage.toFixed(1)}%</span>
            <Progress 
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-sm font-medium">
                {pulse.resources.memoryUsage.toFixed(1)}%</span>
            <Progress 
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Agent Pool</Users>
          <CardDescription>
            {pulse.resources.activeAgents} / {pulse.config.maxConcurrentAgents} agents active</CardDescription>
        <CardContent>
              ...
              <div key={agent.agentId} className="flex items-center justify-between p-3 border rounded-lg">
                <div className="flex items-center gap-3">
                  <Badge variant={agent.isAvailable ? 'success' : 'secondary'}>
                    {agent.isAvailable ? 'Available' : 'Busy'}</Badge>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Task Queue</AlertCircle>
          <CardDescription>
            {pulse.taskQueue.length} tasks pending</CardDescription>
        <CardContent>
