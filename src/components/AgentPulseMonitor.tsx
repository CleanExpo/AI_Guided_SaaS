...
interface AgentMetrics {
  agentId: string, isAvailable: boolean, executionCount: number, averageExecutionTime: number, cooldownRemaining: number
}

interface PulseStatus {
  pulse: {
    config: {
      maxConcurrentAgents: number, pulseInterval: number, cooldownPeriod: number, maxMemoryUsage: number, maxCpuUsage: number
    }
    taskQueue: {
    ...
    resources: {
      cpuUsage: number, memoryUsage: number, activeAgents: number, queuedTasks: number
    }
