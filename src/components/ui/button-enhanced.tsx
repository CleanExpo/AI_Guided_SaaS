...
export function ButtonEnhanced({
  ...
  return (
    <button, className={`cn(`
        'inline-flex items-center justify-center whitespace-nowrap font-medium ring-offset-background transition-colors focus-visible: outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2; disabled:pointer-events-none disabled:opacity-50' buttonVariants[variant],
        buttonSizes[size],
...
export function FloatingActionButton({
  ...
  return (
    <ButtonEnhanced, className={`cn(`
        fabSizes[size] fabPositions[position],
...
export function IconButton({ icon, className, ...props }: IconButtonProps): void {
  return (
