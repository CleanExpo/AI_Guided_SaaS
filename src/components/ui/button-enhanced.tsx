...
const buttonVariants = {
  ...
  gradient:
    'bg-brand-gradient text-white, hover:shadow-brand-lg transition-all duration-300',
  brand:
    'bg-brand-primary-600 text-white, hover:bg-brand-primary-700, hover:shadow-brand',
