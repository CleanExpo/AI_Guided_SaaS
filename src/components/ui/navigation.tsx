...
export function Breadcrumb({
  ...
  className,
  maxItems = 5}: BreadcrumbProps): void {
  const displayItems =;
...
export function AutoBreadcrumb({
  ...
  homeLabel = 'Home',
  homeHref = '/',
  pathMapping = {}}: AutoBreadcrumbProps): void {
...
export function NavigationMenu({
  ...
  variant = 'default',
  className,
  onItemClick}: NavigationMenuProps): void {
  const pathname = usePathname();
...
export function MobileNavigation({
  ...
  trigger,
  className,
  onItemClick}: MobileNavigationProps): void {
...
export function Pagination({
  ...
  showPrevNext = true,
  maxVisiblePages = 5,
  className}: PaginationProps): void {
