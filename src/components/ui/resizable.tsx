...
const _ResizablePanelGroup = ({
  className, ...props
}: React.ComponentProps<typeof ResizablePrimitive.PanelGroup>) => (<ResizablePrimitive.PanelGroup, className={cn('flex h-full w-full data-[panel-group-direction=vertical]:flex-col' className)},
    {...props}
   />
)
