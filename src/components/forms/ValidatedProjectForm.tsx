...
const value  = {formData.type}
                const onValueChange = {(value) => updateField('type', value as any)}
              ></Select>
...
const value = {formData.config?.framework || ''}
                const onValueChange  = {(value) => updateConfig('framework', value)}
              ></Select>
...
const value = {formData.config?.language || ''}
                const onValueChange  = {(value) => updateConfig('language', value)}
              ></Select>
...
const value = {formData.config?.database || ''}
                const onValueChange = {(value) => updateConfig('database', value)}
              ></Select>
