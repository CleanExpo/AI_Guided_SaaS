...
Format as JSON array of Recommendation objects.`;`
  ...
  private async developStrategies(
    ...
    const strategyPrompt = `Develop implementation strategies for these, recommendations: Situation; Summary:`
${situation.summary}
Key, Recommendations:
...
Format as JSON array of Strategy objects.`;`
  ...
  private async assessRisks(
    ...
    const riskPrompt = `Assess risks associated with the recommendations and, strategies: Situation; Challenges:`
...
Format as JSON array of RiskAssessment objects.`;`
  ...
  private async evaluateAlternatives(
    ...
    const alternativePrompt = `Evaluate alternative approaches to the, recommendations: Original; Request:`
"${input}"
Current, Situation:
${situation.summary}
...
Format as JSON DecisionMatrix object.`;`
    ...
    const weightedScores = matrix.options.map((_, optionIndex: number) => {
  ...
  private async developActionPlan(
    ...
    const actionPrompt = `Develop a comprehensive action, plan: Selected; Option: ${decisionMatrix.recommendation}`
Key, Recommendations:
${recommendations
