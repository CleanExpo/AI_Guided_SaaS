...
export class ProjectManagerAgent extends Agent {
  constructor() {
    super({
      ...
      description: 'Expert in project planning, resource allocation, timeline management, and risk mitigation. Creates comprehensive project plans from requirements.',
      capabilities: [
        'Project planning',
        'Timeline estimation',
        'Resource allocation',
