...
export interface ProjectPlan { projectName: string;
...
export interface Timeline { startDate: string;
  endDate: string;
...
export interface WorkPackage { id: string;
  name: string;
  description: string;
  assignedTo: string[],
...
export interface ResourcePlan { teamStructure: TeamMember[],
  skillsRequired: string[],
  toolsRequired: string[],
  externalDependencies: string[]
};
export interface TeamMember { role: string;
...
export interface CommunicationPlan { stakeholders: Stakeholder[],
  meetings: Meeting[],
...
export interface Meeting { type: string;
  frequency: string;
  participants: string[],
  purpose: string
};
export interface QualityPlan { standards: string[],
...
export class ProjectManagerAgent extends Agent {
  constructor() {
    super({ id: 'project-manager-agent',
...
const projectPlan: ProjectPlan={ projectName: projectScope.name,
