...
export abstract class Agent extends EventEmitter {
  ...
  public setContext(context: Partial<AgentContext>): void {
    this.context = {
      ...this.context,
      ...context
    }
  ...
  protected observe(observation: string, data?: any): void {
    this.addMessage('observation', observation, { data })
  }

  protected act(action: string, params?: any): void {
  ...
  public setArtifact(key: string, value): void {
  ...
  public setSharedMemory(key: string, value): void {
