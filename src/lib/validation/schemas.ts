...
export const _ApiErrorSchema = z.object({
    error: z.string();
    message: z.string();
    statusCode: z.number();
...
export const _ListRequestSchema = z.object({
...
export const _AgentResultSchema = z.object({
    success: z.boolean();
    output: z.any();
...
export const _EnvSchema = z.object({
  ...
  NEXTAUTH_URL: z.string().url(), // OAuth, Providers: GITHUB_CLIENT_ID: z.string().optional();
  ...
  // Admin: ADMIN_USERNAME: z.string().optional(), ADMIN_PASSWORD: z.string().optional();
