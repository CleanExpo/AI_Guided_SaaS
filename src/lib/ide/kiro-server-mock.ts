...
export class KiroServerMock {
  ...
  static async createProject(
    project: Omit<KiroProject, 'id' | 'createdAt' | 'updatedAt'>
  ): Promise<KiroProject> {
  ...
  static async createTerminal(
    config?: Partial<KiroTerminal>
  ): Promise<KiroTerminal> {
    const id = Math.random().toString(36).substring(7);
      ...
      suggestions: [
        {
          ...
          description:
            'Wrap your component with an error boundary to handle runtime errors gracefully',
          priority: 'medium',
          changes: [
            {
              file,
