...
export class AIService {
  ...
  private async generateOpenAIResponse(prompt: string, systemPrompt?: string): Promise<AIResponse> {
    if (!this.openai) {
  ...
  private async generateAnthropicResponse(prompt: string, systemPrompt?: string): Promise<AIResponse> {
    if (!this.anthropic) {
  ...
  private async generateFallbackResponse(prompt: string, systemPrompt?: string): Promise<AIResponse> {
...
For now, I can provide basic assistance, with:
- Component templates
- Code structure
- General guidance`
    }
