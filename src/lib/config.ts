...
class ConfigurationManager {
   ...
   */
  private parsePropertiesFile(content: string): Record {
...
properties: Record<string, string>
  ...
  primary: properties['ai.provider.primary'] || 'openai',
    ...
    tokensContext: parseInt(properties['openai.tokens.context'] || '8192'), temperatureDefault: parseFloat(
    ...
    tokensContext: parseInt(properties['google.tokens.context'] || '32768'), temperatureDefault: parseFloat(
