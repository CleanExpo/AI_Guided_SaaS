...
const isScheduled = input.schedule !== undefined;
...
const config = isScheduled ? defaultConfig : {
  ...defaultConfig,
  ...input,
...
const totalSkipped = (unitTests.skipped || 0) + (integrationTests.skipped || 0) + (e2eTests.skipped || 0);
