      ...
      <div className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              How to communicate effectively and respectfully in our community
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  • Use clear, descriptive titles for your posts and questions
                </li>
                <li>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Our commitment to creating an inclusive and welcoming environment
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Standards for sharing content in our community
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              How we maintain community standards
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  and guidance on community standards.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  result in permanent removal from the community.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  appeal by contacting our team at appeals@aiguidedSaaS.com.
                </p>
              </div>
            </div>
          </CardContent>
