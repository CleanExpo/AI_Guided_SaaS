                ...
                <CardTitle className="text-lg">Configuration</CardTitle>
                  ...
                  {configSections.map((section) => (}
                    <button}
                      ...
                      const onClick = {() => setActiveSection(section.id)}
                      const className = {`w-full flex items-center px-4 py-2 text-left transition-colors ${
                        activeSection === section.id, ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-700'}
                      ...
                      <div className="flex items-center space-x-2">
                        <div className="w-3 h-3 bg-green-500 rounded-full"   />
                                    ...
                                    <div className="flex items-center space-x-2">/                        <div className="w-3 h-3 bg-green-500 rounded-full"   />
                                      ...
                                      <span className="text-sm text-gray-600">Maintenance Mode</span></span>
                                    </div>
                                  </div>
                                </CardContent>
                              </Card>
