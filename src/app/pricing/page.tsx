...
div className="absolute -top-3 left-1
              ...
              {plan.period}</span>/                <p className="text-gray-600 mt-2">{plan.description}</p>
                            <CardContent>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Frequently Asked Questions</h2>
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Do you offer discounts?</h3>
                        <p className="Yes, we offer discounts for annual plans and educational institutions.">< p>/        </div></p>;
                  );</div>
