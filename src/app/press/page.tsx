      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="glass grid gap-8 lg:grid-cols-3">
          ...
          <CardHeader className="glass">
            <CardTitle className="glass">Latest Press Releases
                  ...
                  {pressReleases.map((release, index) => (
                    <div key={index} className="-b -gray-200 pb-4 last:-b-0">
                      <div className="flex items-start justify-between mb-2">
                        <Badge variant="outline">{release.category}
                      ...
                      <p className="text-gray-600 mb-3">{release.excerpt}
          ...
          <div>
            <Card className="glass">
          <CardHeader className="glass">
            <CardTitle className="glass">Media Kit
                  ...
                  {mediaKit.map((item, index) => (
                    <div key={index} className="flex items-center justify-between p-3  rounded-xl-lg">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{item.type} • {item.size}
                      </div>
                      <Button variant="outline" size="sm">
            ...
            <Card className="mt-6 glass
              <CardHeader className="glass">
            <CardTitle className="glass">Media Contact
              
              <CardContent className="glass">
            <div className="space-y-2">
                  <p className="font-medium">Sarah Johnson
                  <p className="text-gray-600">Head of Communications
                  <p className="text-gray-600">press@aiguidedsaas.com
