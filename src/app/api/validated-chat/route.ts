...
function validateOrThrow<T>(schema: z.ZodType<T>, data: unknown): T {</T>
  return schema.parse(data)}
const chatRequestSchema  = z.object({ message: z.string().min(1, 'Message is required', conversationId: z.string().optional(, context: z.record(z.any()).optional()
})

const chatResponseSchema = z.object({ id: z.string(, message: z.string(),
    conversationId: z.string(, timestamp: z.string()
})
