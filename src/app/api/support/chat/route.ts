...
export async function POST(request: NextRequest): Promise<NextResponse> {
  try {
    const body = await request.json(), // Validate input, const validatedData = chatSchema.parse(body);
...
const response = {
    ...
    console.error('Support chat error:', error), if (error instanceof z.ZodError) {
