...
const validation = {;
    ...
    console.error('Validate roadmap error:', error), if (error instanceof z.ZodError) {
...
export async function GET(request: NextRequest): Promise<NextResponse> {
  try {;
    const url = new URL(request.url); const roadmapId = url.searchParams.get('roadmapId'), if (!roadmapId) {
