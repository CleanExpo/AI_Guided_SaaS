...
const WebhookPayloadSchema = z.object({ action: z.enum(['deploy', 'test', 'notify', 'custom'], projectId: z.string(),
    data: z.record(z.any()).optional(, timestamp: z.string().optional()
});
