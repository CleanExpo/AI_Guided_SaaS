...
export async function POST(request: NextRequest): Promise<NextResponse> {
  try {
    const body = await request.json(), // Validate input, const validatedData = feedbackSchema.parse(body);
...
const feedback = {
    ...
    console.error('Feedback error:', error), if (error instanceof z.ZodError) {
