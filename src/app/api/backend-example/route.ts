...
export async function POST(request: NextRequest): Promise<NextResponse> {
    try {
        const body = await request.json(), // Validate input, const validatedData = CreateProjectSchema.parse(body);
...
const project = {
        ...
        console.error('Create project error:', error), if (error instanceof z.ZodError) {
