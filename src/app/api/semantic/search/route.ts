...
const searchSchema = z.object({ query: z.string().min(1, filters: z.record(z.any()).optional(, size: z.number().min(1).max(100).optional().default(7, includeSource: z.boolean().optional().default(true)
});
