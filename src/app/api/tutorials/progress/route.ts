...
export async function POST(request: NextRequest): Promise<NextResponse> {
  try {
    const body = await request.json(), // Validate input, const validatedData = progressSchema.parse(body);
...
const progress = {
    ...
    console.error('Tutorial progress error:', error), if (error instanceof z.ZodError) {
