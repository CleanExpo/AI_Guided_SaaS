  ...
  try {
    ...
    switch (action) {
      ...
      case 'content':
        ...
        const content = await adminService.getContentForModeration(contentPage, contentLimit, {
          type: contentType,
      ...
      case 'activity':
        ...
        const activity = await adminService.getAdminActivity(activityPage, activityLimit, {
          adminId,
          action: actionFilter
        })
