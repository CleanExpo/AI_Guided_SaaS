  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Security & Compliance<
              h1>
...
<
  ...
  return (
          ...
          {securityFeatures.map((feature) => (\n    <
              ...
              <
              div>
                              <CardTitle className="text-lg">{feature.title}<
              CardTitle>
                            <CardContent>
                <p className="text-gray-600 text-center mb-3">{feature.description}<
              p>
...
<
      ...
      <
          ...
          <CardHeader>
            <CardTitle className="text-2xl">Security Certifications & Compliance<
              CardTitle>
                        <CardContent>
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              ...
              div>}
                  ...
                  <h3 className="font-semibold text-gray-900 mb-2">{cert.name}<
              h3>
                                <Badge className="mb-2">{cert.status}<
              Badge>
      ...
      <
          ...
          <CardHeader>
            <CardTitle className="text-2xl">Security Practices<
              CardTitle>
                        <CardContent>
            <div className="grid gap-6 md:grid-cols-2">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Data Protection<
              h3>
...
<
              ...
              div>
                            <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Access Control<
              h3>
                              <ul className="space-y-2 text-gray-600">
                  <li className="flex items-center">
                    <CheckCircle className="h-4 w-4 text-green-500 mr-2" 
...
<
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Security Questions?<
              h2>
