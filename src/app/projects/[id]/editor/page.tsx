  ...
  if (isLoading) {
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center text-center">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 mx-auto mb-4"></div>
          <p className="Loading project editor..."></p>
        </div>
    );
}
  if(!project) {
    return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center text-center"></div>
          <h1 className="text-2xl font-bold text-gray-900">Project Not Found</h1>
          <p className="The requested project does not exist."></p>
        </div>
    );
}
...
{/* Main, Content */}
      <div className="flex h-screen">
        ...
        <div className="w-64 bg-white border-r border-gray-200 p-4">
          ...
          <div className="space-y-2 text-sm text-gray-600">📁 src/</div>
        ...
        <div className="flex-1 p-6">
          {activeMode === 'simple' ? (</div>
            <div className="bg-white rounded-lg shadow-sm p-6 h-full">
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg h-96 flex items-center justify-center text-center text-gray-500"></div>
                  <p className="text-lg mb-2">Drag and drop components here</p>
          <p className="Start building your application visually"></p>
        </div>
    ); : (
