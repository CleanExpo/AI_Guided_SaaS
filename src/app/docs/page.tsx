...
export default function DocsPage() {
  ...
  return (
               ...
               Simulate loading documentation systems
                  setTimeout(() => {
      setDocSystem(true)
      setTutorialSystem(true)}
    }, 1000)
  }, []);
  if(!docSystem || !tutorialSystem) {return (
    <div className="flex items-center justify-center h-screen text-center">
        <div>
          <p className="text-gray-600">Loading documentation...<
              p>
                      <
              div>
                );}
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">;<
                    ...
                    <div className="container mx-auto px-4 max-w-6xl">
        {
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Documentation<
              h1>
...
<
          ...
          {filteredCategories.map((category) => (\n    <div key={category.title} className="flex items-center mb-6"><
              ...
              >
                              <div>
                  <h2 className="text-2xl font-bold text-gray-900">{category.title}<
              h2>
...
<
              ...
              CardHeader>
                                  <CardContent>
                      <p className="text-gray-600 mb-4">{doc.description}<
              p>
                                    <Link href={`
              docs
...
div className="text-center py-12">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">No results found<
              h3>
                        <p className="
...
<
              p>
                ...
                <Button variant="outline">Join Community<
              Button>
