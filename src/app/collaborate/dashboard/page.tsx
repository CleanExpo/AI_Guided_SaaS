      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mb-8">
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <h3 className="font-semibold text-gray-900 mb-2">Active Projects<
              h3>
                          <div className="text-3xl font-bold text-blue-600">3<
              div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <h3 className="font-semibold text-gray-900 mb-2">Team Members<
              h3>
                          <div className="text-3xl font-bold text-green-600">12<
              div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <h3 className="font-semibold text-gray-900 mb-2">Recent Activity<
              h3>
                          <div className="text-3xl font-bold text-purple-600">24<
              div>
        ...
        <div className="bg-white rounded-lg shadow-sm border">
          <div className="p-6 border-b">
            ...
            <div className="flex items-center justify-between py-4 border-b border-gray-100 last:border-b-0">
              <div>
                <h3 className="font-medium text-gray-900">E-commerce Platform<
              h3>
            ...
            <div className="flex items-center justify-between py-4 border-b border-gray-100 last:border-b-0">
              <div>
                <h3 className="font-medium text-gray-900">Mobile App UI<
              h3>
