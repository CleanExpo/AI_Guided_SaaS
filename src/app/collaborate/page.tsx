...
props: anyexport default function CollaboratePage(): void {
  const { data: session, status   }: any = useSession();
  const [activeProject, setActiveProject]: any[] = useState<string | null>(null);
  const [projectName, setProjectName]: any[] = useState<any>('');
  const [showWorkspace, setShowWorkspace]: any[] = useState<any>(false);
  const mockProjects = [;,
  {
  id: '1',
