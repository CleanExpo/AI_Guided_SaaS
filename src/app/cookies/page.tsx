      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="space-y-8">
          ...
          <CardHeader className="glass">
            <CardTitle className="glass">What are cookies?
          ...
          <Card className="glass">
          <CardHeader className="glass">
            <CardTitle className="glass">How we use cookies
          ...
          <Card className="glass">
          <CardHeader className="glass">
            <CardTitle className="glass">Managing cookies
          ...
          <Card className="glass">
          <CardHeader className="glass">
            <CardTitle className="glass">Contact us
