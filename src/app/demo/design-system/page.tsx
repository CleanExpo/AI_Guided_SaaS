...
export const metadata: Metadata = { title: 'Design System Demo - AI Guided SaaS Platform',
    ...
    <div className="min-h-screen bg-gray-50 py-8">
        ...
        <div className="grid gap-8">
          ...
          <div className="space-y-2">
                  <div className="w-full h-16 bg-blue-600 rounded">
          <p className="text-sm font-medium">Primary</p>
                  <p className="text-xs text-gray-500">#2563eb</p>
                </div>
                <div className="space-y-2">
          <div className="w-full h-16 bg-gray-900 rounded">
                  <p className="text-sm font-medium">Secondary</p>
                  <p className="text-xs text-gray-500">#111827</p>
                </div>
                <div className="space-y-2">
          <div className="w-full h-16 bg-green-600 rounded">
                  <p className="text-sm font-medium">Success</p>
                  <p className="text-xs text-gray-500">#16a34a</p>
                </div>
                <div className="space-y-2">
          <div className="w-full h-16 bg-red-600 rounded">
                  <p className="text-sm font-medium">Error</p>
                  <p className="text-xs text-gray-500">#dc2626</p>
                </div>
                <div className="space-y-2">
          <div className="w-full h-16 bg-yellow-500 rounded">
                  <p className="text-sm font-medium">Warning</p>
                  <p className="text-xs text-gray-500">#eab308</p>
                </div>
                <div className="space-y-2">
          <div className="w-full h-16 bg-blue-500 rounded">
