...
import { Input } from '@/components/ui/input';/export default function DesignSystemDemoPage() {
  return (/    <div className="min-h-screen bg-gray-50 py-8 container mx-auto px-4 max-w-6xl">
        <div className="mb-8">
  ...
  return (
              ...
              * Typography *
              ...
              CardTitle>
                ...
                <h1 className="text-4xl font-bold">Heading 1<
              h1>
                              <h2 className="text-3xl font-semibold">Heading 2<
              h2>
                              <h3 className="text-2xl font-medium">Heading 3<
              h3>
                              <h4 className="text-xl">Heading 4<
              h4>
...
<
              ...
              * Colors *
              ...
              div>
                                <p className="text-sm font-medium">Destructive<
              p>
                            <
              div>
                          <
