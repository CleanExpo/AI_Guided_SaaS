  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Help & Support<
              h1>
...
<
  ...
  return (
          ...
          {supportOptions.map((option) => (\n    <
              ...
              <
              div>
                              <CardTitle className="text-lg">{option.title}<
              CardTitle>
                            <CardContent>
                <p className="text-gray-600 text-center">{option.description}<
              p>
              <
              Card>
                        ))}
      <
          ...
          <CardHeader>
            <CardTitle className="text-2xl">Frequently Asked Questions<
              CardTitle>
                        <CardContent>
            <div className="space-y-6">
              ...
              div>
                      ...
                      <h3 className="font-semibold text-gray-900 mb-2">{faq.question}<
              h3>
      ...
      <
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Still need help?<
              h2>
                        <p className="text-gray-600 mb-6">Our support team is here to assist you.<
              p>
