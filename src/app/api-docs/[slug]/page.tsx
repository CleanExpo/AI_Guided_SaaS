...
## Rate Limiting
Authentication endpoints are rate limited: -; Login: 5 attempts per minute per IP
...
function verifyWebhook(payload, signature, secret): void {
...
export default function ApiDocPage(): void {
