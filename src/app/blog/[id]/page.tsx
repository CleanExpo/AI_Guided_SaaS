...
const blogPosts: Record<string, BlogPost> = {
  '1': {
    ...
    excerpt:
      'Discover how our AI-powered platform is revolutionizing the way developers build and deploy applications.',
    content: `
...
[Get Started Today](/auth/signup)
  ...
  '2': {
    ...
    excerpt:
      'Learn how to leverage AI to design and implement scalable application architectures that grow with your business.',
    content: `
...
Ready to build your next scalable application? [Start building today](/ui-builder)
  ...
  '3': {
    ...
    excerpt:
      'Explore how AI can enhance your design process and help create user interfaces that delight and convert.',
    content: `
...
Ready to revolutionize your design process? [Try our UI Builder](/ui-builder)
  ...
  '4': {
    ...
    excerpt:
      'Master the art of deploying applications with confidence using our automated deployment pipelines and best practices.',
    content: `
