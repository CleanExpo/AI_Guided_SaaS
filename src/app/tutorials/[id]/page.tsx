...
const tutorials: Record<string, Tutorial> = {
  '1': {
    ...
    content:
      'Welcome to AI Guided SaaS! This tutorial will walk you through the fundamental concepts and features of our platform.',
    difficulty: 'Beginner',
    duration: '15 min',
  ...
  '2': {
    ...
    content:
      'Take your UI building skills to the next level with advanced techniques and patterns.',
  ...
  '3': {
    ...
    description:
      'Connect your applications to external APIs and manage data effectively',
    content:
      'Learn how to integrate with external APIs and implement robust data management strategies.',
    difficulty: 'Intermediate',
    duration: '30 min',
    author: 'Backend Team',
  ...
  '4': {
    ...
    description:
      'Deploy your applications with confidence using our deployment tools',
    content:
      'Master the deployment process and learn production best practices for scalable applications.',
    difficulty: 'Advanced',
    duration: '40 min',
    author: 'DevOps Team',
  ...
  '5': {
    ...
    description:
      'Work effectively with your team using our collaboration features',
    content:
      'Learn how to collaborate effectively with your team using our built-in collaboration tools.',
    difficulty: 'Intermediate',
    duration: '20 min',
  ...
  '6': {
    ...
    content:
      'Learn advanced techniques for optimizing application performance and preparing for scale.',
    difficulty: 'Advanced',
    duration: '35 min',
