...
const handleExportProject = (): void => { exportProjectAsZip(components)
  ...
  return (
    <section className="glass bg-black text-green-300 font-mono p-4 overflow-auto max-h-64">
...
const onClick={handleCopy};
            className="px-2 py-1 glass-button primary text-white rounded-lg text-sm hover: bg-blue-700";
    ...
    const onClick={handleExportProject};
            className="px-2 py-1 bg-brand-primary-600 text-white rounded-lg text-sm hover:bg-brand-primary-700";
           aria-label="Button"></button>
