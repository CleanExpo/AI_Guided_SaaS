export const PULSE_CONFIG = {
  // Development environment - conservative settings, development: {
    ...
    pulseInterval: 2000, // 2 seconds, cooldownPeriod: 5000, // 5 seconds, maxMemoryUsage: 70, // 70%
    maxCpuUsage: 60, // 60%
  ...
  // Production environment - optimized settings, production: {
    ...
    pulseInterval: 1000, // 1 second, cooldownPeriod: 3000, // 3 seconds, maxMemoryUsage: 80, // 80%
    maxCpuUsage: 70, // 70%
    enableAdaptiveThrottling: true
  },
  ...
  // Resource-constrained environment, constrained: {
    ...
    pulseInterval: 3000, // 3 seconds, cooldownPeriod: 10000, // 10 seconds, maxMemoryUsage: 50, // 50%
    maxCpuUsage: 40, // 40%
    enableAdaptiveThrottling: true
  },
  ...
  // High-performance environment, performance: {
    ...
    pulseInterval: 500, // 0.5 seconds, cooldownPeriod: 1000, // 1 second, maxMemoryUsage: 90, // 90%
    maxCpuUsage: 85, // 85%
    enableAdaptiveThrottling: true
  }
}
