...
declare module "next-auth/jwt" {
  ...
  async applyFixes(): Promise<void> {
    ...
    for(const fix of this.fixes: any): any {
      try {
  ...
  private async applyFix(fix: TypeScriptFix): Promise<void> {
    ...
    if(fix.filesToCreate: any): any {
      for(const file of fix.filesToCreate: any): any {
    ...
    if(fix.filesToUpdate: any): any { for(const update of fix.filesToUpdate: any): any {
