...
test.describe('Comprehensive Platform Validation', () => {
  ...
  test.describe('Core Pages - No 404s', () => {
    ...
    for (const pageInfo of pages) {
      test(`should, load ${pageInfo.path} without 404`, async ({ page }) => {
  ...
  test.describe('Admin Dashboard', () => {
    ...
    test('should have admin dashboard structure', async ({ page }) => {
  ...
  test.describe('Builder Pages', () => {
    test('should load no-code builder', async ({ page }) => {
      await page.goto('http://localhost:3004/builder/no-code')
      await expect(page).not.toHaveTitle('404')
    })
    
    test('should load pro-code editor', async ({ page }) => {
  ...
  test.describe('API Endpoints', () => {
    ...
    test('should have working admin endpoint', async ({ request }) => {
  ...
  test.describe('Core Components', () => {
    test('should render landing page with key elements', async ({ page }) => {
      await page.goto('http://localhost:3004')
  ...
  test.describe('Collaboration Features', () => {
    test('should load collaboration workspace', async ({ page }) => {
  ...
  test.describe('No Mock Data - Real Integration', () => {
    test('should fetch real template data', async ({ page, request }) => {
      const response = await request.get('http://localhost:3004/api/templates')
      expect(response.status()).toBeLessThan(500)
